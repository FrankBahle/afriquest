...
export const APP_TRANSLATIONS = {
  en: {
    ...
    languageHelp: 'When you choose a language, the app saves your preference and loads matching card translations from Firebase where available.',
    ...
    cardDesignHelp: 'Card images are loaded from Firebase problemCards and aiCards where frontImageUrl or backImageUrl exists.',
    ...
    rewardsHelp: 'Connect sponsor rewards, launch messages and claim history to Firebase.',
  ...
  fr: {
    ...
    languageHelp: 'Lorsque vous choisissez une langue, l’application enregistre votre préférence et charge les traductions des cartes depuis Firebase si elles existent.',
    ...
    cardDesignHelp: 'Les images des cartes sont chargées depuis Firebase problemCards et aiCards lorsqu’une URL d’image existe.',
    ...
    rewardsHelp: 'Connectez les récompenses des sponsors, les messages de lancement et l’historique des demandes à Firebase.',
  ...
  zu: {
    ...
    languageHelp: 'Uma ukhetha ulimi, uhlelo lugcina okukhethile bese lulanda ukuhumusha kwamakhadi ku-Firebase uma kukhona.',
    ...
    cardDesignHelp: 'Izithombe zamakhadi zilayishwa ku-Firebase problemCards nama-aiCards uma i-URL yesithombe ikhona.',
    ...
    rewardsHelp: 'Xhuma imivuzo yabaxhasi, imiyalezo yokwethula nomlando wezicelo ku-Firebase.',
